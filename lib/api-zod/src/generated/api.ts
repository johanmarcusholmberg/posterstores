...
export const GetOrderResponse = zod.object({
  ...
  items: zod.array(
    zod.object({
      ...
      posterId: zod.number(),
      posterSizeId: zod.number().nullish(),
      posterTitleSnapshot: zod.string(),
      sizeLabelSnapshot: zod.string().nullish(),
      ...
      masterPrintImageUrlSnapshot: zod.string().nullish(),
      previewImageUrlSnapshot: zod.string().nullish(),
      createdAt: zod.string(),
    }),
  ),
  createdAt: zod.string(),
